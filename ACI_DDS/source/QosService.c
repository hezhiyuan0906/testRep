...
void InitialDefaultQos()
{
    ...
    g_default_Qos.defaultDeadlineQosPolicy.period.sec                                           = 0;
    g_default_Qos.defaultDeadlineQosPolicy.period.nanosec                                       = 0;
    ...
    g_default_Qos.defaultPartitionQosPolicy.value.length                                        = 0;
    g_default_Qos.defaultReliabilityQosPolicy.kind                                                = RELIABLE_RELIABILITY_QOS;
    //g_default_Qos.defaultReliabilityQosPolicy.kind                                              = BEST_EFFORT_RELIABILITY_QOS;
    ...
    g_default_Qos.defaultHistoryQosPolicy.depth                                                 = 300;
    ...
    DDS_DATAWRITER_QOS_DEFAULT.history.depth         = 500;
    ...
    DDS_DATAREADER_QOS_DEFAULT.history.depth         = 200;
